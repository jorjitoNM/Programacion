    ...
    public static void main(String[] args) throws IOException {
        ...
        do {
            ...
            switch (opcion) {
                ...
                case 'a':
                    do {
                        System.out.println("Introduzca la planta a la que quiere subir (el ascensor tiene de la -10 a la 25)");
                        plantaanterior = planta;
                        aux = teclado.nextInt();
                        if (aux>plantaanterior && aux<=24 && aux>=-10) {
                ...
                case 'b':
                    do {
                        ...
                        plantaanterior = planta;
                        aux = teclado.nextInt();
                        if (aux<plantaanterior && aux<=25 && aux>=-10) {
                            for (; planta >= aux; planta--) {
                                System.out.println(planta);
                            }
                            planta = planta+1;
