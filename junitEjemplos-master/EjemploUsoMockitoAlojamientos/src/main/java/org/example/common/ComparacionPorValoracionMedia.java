...
public class ComparacionPorValoracionMedia implements Comparator<Alojamiento> {
    ...
    public int compare(Alojamiento arg0, Alojamiento arg1) {
        ...
        return Double.compare(arg1.getValoraciones().stream().mapToInt(value -> value).average().orElse(0),arg0.getValoraciones().stream().mapToInt(value -> value).average().orElse(0));
    }
