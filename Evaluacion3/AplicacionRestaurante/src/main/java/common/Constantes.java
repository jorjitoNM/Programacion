...
public class Constantes {
    ...
    public static final String EL_TIEMPO_ESTIMAD_ES = "El tiempo estimado de peapracion de su producto es de ";
    ...
    public static final String NO_HAY_PEDIDOS = "Usted no tiene pedidos ";
